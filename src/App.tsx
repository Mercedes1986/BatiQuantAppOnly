...
import { armInterstitialAfterCalculation, clearPendingInterstitial, hideBanner, initializeAds, showPendingInterstitialIfReady } from "./services/adsService";
import { hasUserChoice, initConsent } from "./services/consentService";
...
import { isNativeAdsBridgeAvailable, reportNativeBottomChromeHeight } from "./services/platformService";
...
const canShowWelcomeNow = (): boolean => {
  // Sur Android, le formulaire UMP natif peut s'afficher en dehors de React.
  // Sur le web, on attend que le choix de confidentialité soit fait pour éviter deux fenêtres en même temps.
