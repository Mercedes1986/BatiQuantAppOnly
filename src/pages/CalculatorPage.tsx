...
/**
 * Update goals:
 * - Default values are now EN to avoid FR fallback when an EN key is missing (prevents "Franglais").
 * - Keys are unchanged (so no breaking changes), just safer fallbacks.
 * - Minor cleanup: toast dispatch readability.
 */
