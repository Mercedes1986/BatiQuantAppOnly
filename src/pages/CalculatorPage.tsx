...
export const CalculatorPage: React.FC<Props> = ({ type, onBack, onNavigateProjects }) => {
  ...
  if (!config) {
    return (
      <div className="app-shell app-shell--calculator min-h-screen flex items-center justify-center p-6 text-center text-slate-600">
...
${t("calculator.generated_by", { defaultValue: "Generated by BatiQuant (Offline)" })}`;
  ...
  return (
    <div className="flex flex-col h-full bg-transparent pb-20 overflow-y-auto no-scrollbar">
