      ...
      <div className="max-w-7xl mx-auto p-4 pb-24">
        <header className="mb-6 mt-2 px-2">
          <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">
            Bati<span className="text-blue-600">Quant</span>
          </h1>
          <p className="text-slate-500 text-sm">L&apos;outil de référence pour vos chantiers.</p>
        </header>

        {/* Cards: larger => fewer columns */}
        ...
        {/* Safe ad placement at the bottom, far from tool buttons */}
        <div className="mt-10">
