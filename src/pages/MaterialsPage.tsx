...
export const MaterialsPage: React.FC = () => {
  ...
  return (
    <div className="safe-bottom-offset min-h-full bg-transparent">
      <div className="safe-top-header bg-white border-b border-slate-200 shadow-sm">
            ...
            <div className="flex items-center space-x-1.5 bg-slate-100 p-1 rounded-lg shrink-0">
              <button
                ...
                className={`text-xs font-extrabold px-3 py-1.5 rounded-md transition ${
                  tax.mode === "HT" ? "bg-white shadow text-blue-600" : "text-slate-500 hover:text-slate-700"
                }`}
                type="button"
              >
              ...
              <button
                ...
                className={`text-xs font-extrabold px-3 py-1.5 rounded-md transition ${
                  tax.mode === "TTC" ? "bg-white shadow text-blue-600" : "text-slate-500 hover:text-slate-700"
                }`}
                type="button"
              >
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            >
              ...
              <span className="hidden sm:inline">
                {t("materials.favorites", { defaultValue: "Favorites" })}
              </span>
            </button>
          </div>
                  ...
                  <div className="mt-3.5 flex items-center justify-between gap-3">
                    <div className="relative w-[150px] sm:w-[165px]">
                      <input
                        ...
                        className={`w-full py-2 pl-8 pr-2 border rounded-xl font-mono font-extrabold text-sm ${
                          item.isMapped
        ...
        <div className="p-4 animate-in fade-in max-w-5xl mx-auto">
          {showCustomForm ? (
            ...
            <button
              ...
              className="w-full py-3 mb-4 bg-blue-600 text-white rounded-2xl font-extrabold flex justify-center items-center shadow-md text-sm hover:bg-blue-700 transition"
              type="button"
            >
              ...
              >
                ...
                <div className="flex space-x-1 shrink-0">
                  ...
                  <button
                    ...
                    className="p-2 text-slate-700 hover:text-red-600 hover:bg-red-50 rounded-xl border border-transparent hover:border-red-200 transition"
        ...
        <div className="p-4 space-y-4 animate-in fade-in max-w-3xl mx-auto">
          ...
          <div className="bg-white/80 p-4 rounded-2xl border border-slate-200 shadow-sm">
            ...
            <p className="text-xs text-slate-400 mt-3 text-center">
              {t("materials.backup_hint", {
                defaultValue: "Export your data to transfer to another device.",
              })}
            </p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl w-full max-w-sm max-h-[80vh] flex flex-col shadow-xl">
            ...
            <div className="p-3 border-t">
              <button
                ...
                className="w-full py-2.5 bg-slate-100 rounded-xl text-slate-600 font-extrabold text-sm"
                type="button"
              >
...
const CustomMaterialForm: React.FC<{
  ...
  return (
    <div className="bg-white p-4 rounded-2xl border border-blue-200 shadow-lg mb-4 animate-in zoom-in-95">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            required
            className="w-full p-2.5 border rounded-xl bg-white text-slate-900 text-sm"
        ...
        <div>
          ...
          <input
            ...
            required
            className="w-full p-2.5 border rounded-xl bg-white text-slate-900 text-sm font-extrabold"
          />
        </div>
        ...
        <div className="flex gap-3 pt-2">
          <button
            type="button"
            onClick={onCancel}
            className="flex-1 py-2.5 text-slate-500 text-sm font-extrabold"
          >
            {t("common.cancel", { defaultValue: "Cancel" })}
          </button>
          <button
            type="submit"
            className="flex-1 py-2.5 bg-blue-600 text-white rounded-xl font-extrabold text-sm shadow-sm hover:bg-blue-700 transition"
          >
