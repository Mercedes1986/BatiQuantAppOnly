          ...
          {showForm && typeof document !== "undefined" && createPortal(
            <div className="fixed inset-0 z-[9999]">
              ...
              <div className="absolute inset-0 sm:flex sm:items-center sm:justify-center sm:p-6">
                <div
                  className="relative flex h-full w-full flex-col overflow-hidden bg-white sm:h-auto sm:max-h-[92vh] sm:max-w-md sm:rounded-[26px] sm:border sm:border-white/70 sm:shadow-[0_28px_80px_rgba(15,23,42,0.28)]"
                  onClick={(e) => e.stopPropagation()}
                >
                  <div className="shrink-0 border-b border-slate-100 bg-white px-4 py-4 pt-[max(env(safe-area-inset-top,0px),1rem)]">
                  ...
                  <div className="min-h-0 flex-1 overflow-y-auto px-4 py-4 pb-[calc(env(safe-area-inset-bottom,0px)+7rem)] sm:pb-6">
                    <div className="space-y-4">
                  <div>
                  ...
                  <div className="absolute inset-x-0 bottom-0 z-30 flex gap-3 border-t border-slate-100 bg-white/95 px-4 py-4 pb-[calc(env(safe-area-inset-bottom,0px)+1rem)] backdrop-blur sm:relative sm:inset-auto sm:bg-white sm:backdrop-blur-0">
                    <button
                      type="button"
                      onClick={() => setShowForm(false)}
