          ...
          <div className="space-y-3">
            {rooms.map((r) => (
              <div key={r.id} className="bg-white border border-slate-200 rounded-lg p-3">
                ...
                <div className="flex flex-col gap-3 border-t pt-2 mt-2 sm:flex-row">
            ...
            <div className="bg-slate-50 p-3 rounded-lg border border-blue-200">
              ...
              <div className="grid grid-cols-1 gap-2 mb-2 sm:grid-cols-3">
                <input
                  ...
                  className="p-2 border border-white/80 rounded-2xl text-sm bg-white/92 text-slate-900 shadow-[0_10px_24px_rgba(15,23,42,0.05)] backdrop-blur-xl"
                />
                <input
                  type="number"
